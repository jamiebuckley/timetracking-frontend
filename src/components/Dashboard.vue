<template>
    <div>
        <div v-if="isLoading">
            <h4 class="d-flex justify-content-center my-5">Loading, please wait</h4>
        ...
        <div class="container-fluid py-md-5 py-3 fade-in" v-if="!isLoading">
    ...
    export default {
        ...
        methods: {
            resync: async function () {
                this.isLoading = true;
                await Promise.all([this.fetchProjects(), this.fetchTimes()]);
